...
unitTests =
 ...
 where
   ...
   proposal1 = SIP.mkSIP "Bar" 300
   vkey1 = VerKeyMockDSIGN 74551
   salt1 = 2389
   revelation1 = SIP.mkRevelation vkey1 salt1 proposal1
   vote1 = SIP.mkVote vkey0 (_id proposal1) Proposal.Against
   vote2 = SIP.mkVote vkey1 (_id proposal1) Proposal.Abstain
   -- Approval
   impSubmission0 = IMP.mkSubmission vkey0 salt0 implementation0
   implementation0 = IMP.mkImplementation (SIP.unSIPId $ _id proposal0) 100 protocol1
   ...
   implementation1 = IMP.mkImplementation (SIP.unSIPId $ _id proposal1) 200 protocol2
