...
\begin{property}[Commutativity of Translation]
  ...
  \begin{lemma}
    ...
    $tx$ is a Mary/Alonzo transaction. Suppose also that
    \begin{equation*}
    ...
    \begin{equation*}
      (slot, txIx, \var{chainstate'}_{pp}, acnt)\vdash s \trans{ledger}{tx} s'
    \end{equation*}
  \end{lemma}
  ...
  \begin{proof}
    ...
    additional Alonzo checks all pass:
    \begin{itemize}
    ...
    transition (see below), and the additional Alonzo-specific checks all pass:
    \begin{itemize}
      ...
      \item With an empty redeemer map, total execution units must be zero.
